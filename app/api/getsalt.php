...
$get_salt_sql_query = "SELECT vfm184stock_passwords_salt FROM `vfm184stock_passwords` WHERE vfm184stock_passwords.vfm184stock_passwords_uid = $userid and vfm184stock_passwords_version = (SELECT max(vfm184stock_passwords_version) from vfm184stock_passwords where vfm184stock_passwords_uid = $userid GROUP by vfm184stock_passwords_version limit 1) limit 1";
...
$res->success = true;
$res->message = "salt";
$res->data = $look_for_salt["vfm184stock_passwords_salt"];
